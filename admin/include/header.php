    ...
    <div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="index.php"><img alt="logo" src="assets/img/90x90.jpg"> <span class="navbar-brand-name">Afghan Jobs</span></a>
            </div>
                    ...
                    <nav id="topbar">
                        <ul class="navbar-nav theme-brand flex-row  text-center">
                            ...
                            <li class="nav-item theme-text">
                                <a href="index.php" class="nav-link"> AfghanJobs </a>
                            </li>
                        </ul>
                        ...
                        <ul class="list-unstyled menu-categories" id="topAccordion">
                            ...
                            <li class="menu single-menu active">
                                ...
                                <ul class="collapse submenu list-unstyled animated fadeInUp" id="dashboard" data-parent="#topAccordion">
                                    <li>
                                        <a href="jposting.php"> Post Job </a>
                                    </li>
                                    <li class="active">
